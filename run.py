...
# Use pytorch implementation of AdamW, this below version is going to be depricated
...
# Inserting some fixed level of randomness into the code
def set_seed(args):
...
if __name__ == '__main__':
    ...
    # use tokenizer directly from the transfomred
    tokenizer = AlbertTokenizer.from_pretrained('albert-base-v2', do_lower_case=True, clean_text=False)

    # what the hell are these 'context_transform', 'response_transform' and 'concat_transform'
    # There transforms are custom tokenizer to say, the context_transform is used for the 'question' encoder or context, while the response_transform is for 'answer' encoder. 
    # And the 'concat_transform' is for the cross-encoder.
    # basically these stage the input and output for 'question' and 'answer' encoder
    ...
    # Initializing certain variables for training
    epoch_start = 1
    global_step = 0
